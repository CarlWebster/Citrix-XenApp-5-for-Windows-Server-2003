...
.PARAMETER Summary
	...
	PS C:\PSScript > .\XA52003_Inventory_V41.ps1
...
.EXAMPLE
	PS C:\PSScript > .\XA52003_Inventory_V41.ps1 -PDF -verbose
	...
	Will display verbose messages as the script is running.
.EXAMPLE
	PS C:\PSScript > .\XA52003_Inventory_V41.ps1 -Summary
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\XA52003_Inventory_V41.ps1 -PDF -Summary -verbose
	...
	Will display verbose messages as the script is running.
.EXAMPLE
	PS C:\PSScript > .\XA52003_Inventory_V41.ps1 -Hardware -verbose
	...
	Will display verbose messages as the script is running.
.EXAMPLE
	PS C:\PSScript > .\XA52003_Inventory_V41.ps1 -StartDate "01/01/2014" -EndDate "01/02/2014" -verbose
...
.EXAMPLE
	PS C:\PSScript > .\XA52003_Inventory_V41.ps1 -StartDate "01/01/2014" -EndDate "01/01/2014" -verbose
...
.EXAMPLE
	PS C:\PSScript > .\XA52003_Inventory_V41.ps1 -StartDate "01/01/2014 21:00:00" -EndDate "01/01/2014 22:00:00" -verbose
...
.EXAMPLE
	PS C:\PSScript .\XA52003_Inventory_V41.ps1 -CompanyName "Carl Webster Consulting" -CoverPage "Mod" -UserName "Carl Webster"
...
.EXAMPLE
	PS C:\PSScript .\XA52003_Inventory_V41.ps1 -CN "Carl Webster Consulting" -CP "Mod" -UN "Carl Webster"
